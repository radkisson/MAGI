...
# By default, RIN runs a self-hosted Firecrawl in Docker (no external API key needed)
# The FIRECRAWL_API_KEY is auto-generated by start.sh for the local service
FIRECRAWL_API_KEY=fc-auto-generated-key

# Optional: Use Firecrawl Cloud API instead of self-hosted
# Uncomment these lines to use the cloud service:
# FIRECRAWL_API_URL=https://api.firecrawl.dev
# FIRECRAWL_API_KEY=fc-your-cloud-api-key-from-firecrawl.dev
