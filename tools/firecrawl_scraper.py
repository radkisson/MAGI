...
class Tools:
    ...
    def __init__(self):
        # Get API key from environment (generated by start.sh or user-provided for cloud)
        self.api_key = os.environ.get("FIRECRAWL_API_KEY", "fc-dev-key")
        
        # Check if user wants to use Firecrawl Cloud API instead of self-hosted
        # If FIRECRAWL_API_URL is set, use it. Otherwise, use local Docker service
        self.firecrawl_url = os.environ.get("FIRECRAWL_API_URL", "http://firecrawl:3002")
